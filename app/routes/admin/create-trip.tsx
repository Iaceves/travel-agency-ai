...
// using a deferent country api url that only give back name not coorninates or street map
export const loader = async () => {
  ...
  //flag is added as a function created to add a text to emoji img
        ...
        <form className='trip-form' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input 
              id="duration"
              name="duration"
              placeholder='Enter a number of day for your field trip'
