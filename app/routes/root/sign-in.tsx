...
//                         </h2>
//                         <p className='p-18-regular text-center text-gray-100 !leading-7'>Sign in with Google to manage destination, itenerations, and user activity with ease</p>
//                     </article>
//                     <ButtonComponent
//                         type="button"
